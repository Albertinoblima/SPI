...
UPDATE public.survey_localities SET population_type = 'eleitores'
WHERE population_type = 'voters';
UPDATE public.survey_localities SET population_type = 'habitantes'
WHERE population_type = 'inhabitants';
